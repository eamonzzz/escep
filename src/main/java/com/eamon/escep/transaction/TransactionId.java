package com.eamon.escep.transaction;
...
public final class TransactionId implements Serializable, Comparable<TransactionId> {
     ...
     * same parameters.
     *
     * @param pubKey          the key on which to base the transaction ID.
     * @param digestAlgorithm the algorithm to use to digest the key
