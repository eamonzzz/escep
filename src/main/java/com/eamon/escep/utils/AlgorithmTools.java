...
public abstract class AlgorithmTools {
     ...
     * Log4j instance
     */
    private static final Logger log = LoggerFactory.getLogger(AlgorithmTools.class);
        ...
        if (publicKey instanceof RSAPublicKey) {
            ...
            if (ecPublicKey.getParams() instanceof ECNamedCurveSpec) {
                ...
                if (namedCurve != null) {
                    ...
                    @SuppressWarnings("unchecked") final Enumeration<String> ecNamedCurves = ECNamedCurveTable.getNames();
    ...
    public static String getCertSignatureAlgorithmNameAsString(Certificate cert) {
        final String certSignatureAlgorithm;
        {
            ...
            if (cert instanceof X509Certificate) {
                ...
                throw new RuntimeException("Certificate type neither X509 nor CVS.");
            }
