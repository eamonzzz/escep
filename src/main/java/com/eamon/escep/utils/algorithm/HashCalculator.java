...
import com.eamon.escep.utils.algorithm.concurrent.ConcurrentBag;
import com.eamon.escep.utils.algorithm.concurrent.ConcurrentBagEntry;
...
class HashCalculator {
  ...
  public static String base64Sha1(byte[] data) {
    return Base64.encodeBase64String(hash(HashAlgo.SHA1, data, 0, data.length));
  }

  public static String base64Sha1(byte[] data, int offset, int len) {
    return Base64.encodeBase64String(hash(HashAlgo.SHA1, data, offset, len));
  }
  ...
  public static String base64Sha256(byte[] data) {
    return Base64.encodeBase64String(hash(HashAlgo.SHA256, data, 0, data.length));
  }

  public static String base64Sha256(byte[] data, int offset, int len) {
    return Base64.encodeBase64String(hash(HashAlgo.SHA256, data, offset, len));
  }
  ...
  public static String base64Hash(HashAlgo hashAlgo, byte[] data) {
    return Base64.encodeBase64String(hash(hashAlgo, data, 0, data.length));
  }

  public static String base64Hash(HashAlgo hashAlgo, byte[] data, int offset, int len) {
    return Base64.encodeBase64String(hash(hashAlgo, data, offset, len));
  }
