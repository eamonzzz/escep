 ...
 * {@link it.trento.comune.j4sign.cms.ExternalSignatureSignerInfoGenerator}.
 * </p>
 * <p>
 ...
 *
 *   //{@link it.trento.comune.j4sign.cms.ExternalSignatureSignerInfoGenerator} encapsulates SignerInfos,
...
public class ExternalSignatureCMSSignedDataGenerator {
    ...
    /**
     * The repository of {@link }objects,
    ...
    public void addCertificatesAndCRLs(CertStore certStore)
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                certs.add(org.bouncycastle.asn1.x509.Certificate.getInstance((ASN1Sequence) makeObj(c.getEncoded())));
            }
        } catch (IOException e) {
     ...
     *
     * @param si
     *            - the {@link it.trento.comune.j4sign.cms.ExternalSignatureSignerInfoGenerator}object that
     ...
     * {@link it.trento.comune.j4sign.cms.ExternalSignatureSignerInfoGenerator} objects; if encapsulate is
