 ...
 */
/*
 * $Header: /cvsroot/j4sign/j4sign/src/java/core/it/trento/comune/j4sign/cms/ExternalSignatureSignerInfoGenerator.java,v 1.9 2017/07/27 16:32:58 resoli Exp $
 * $Revision: 1.9 $
 * $Date: 2017/07/27 16:32:58 $
 */

package com.eamon.escep.cms;
...
public class ExternalSignatureSignerInfoGenerator {
    ...
    public void setsAttr(AttributeTable sAttr) {
        this.sAttr = sAttr;
    }
    ...
    public void setUnsAttr(AttributeTable unsAttr) {
    ...
    SignerInfo generate() throws CertificateEncodingException, IOException {
        ...
        if (this.getEncryptionAlgOID().equals(
            ...
            encAlgId = new AlgorithmIdentifier(new ASN1ObjectIdentifier(this.getEncryptionAlgOID()), DERNull.INSTANCE);
        }

        ASN1OctetString encDigest = new DEROctetString(this.signedBytes);
        X509Certificate cert = this.getCertificate();
        X509CertificateHolder certHolder = new X509CertificateHolder(cert.getEncoded());
        IssuerAndSerialNumber encSid = new IssuerAndSerialNumber(certHolder.toASN1Structure());
...
//            v.add(buildSigningCertificateV2Attribute(sigProvider));
    ...
    private Attribute buildSigningCertificateV2Attribute(String sigProvider)
        ...
        GeneralNames generalNames = new GeneralNames(generalName);
        BigInteger serialNum = holder.getSerialNumber();
